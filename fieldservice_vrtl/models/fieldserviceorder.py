...
class FieldServiceOrder(models.Model):
    ...
    line_count_avg = fields.Integer(group_operator='avg',string='Line Count (AVG)', compute='_compute_line_count', store=True)
    total_duration = fields.Float(string='Total Duration', compute='_compute_total_duration', store=True, help='Total duration of all lines')
