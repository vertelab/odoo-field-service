...
class FieldServiceOrder(models.Model):
    ...
    time_until_work_done_max = fields.Float(group_operator='max', string='Arrival Time (MAX)',
                                            compute='_compute_time_until_work_done', store=True, help='Time in hours')
    ## else
    reaction_time_avg = fields.Float(string='Reaction Time (AVG)', aggregator='avg',
                                     compute='_compute_reaktion_time', store=True, help='Time in hours')
    reaction_time_min = fields.Float(string='Reaction Time (MIN)', aggregator='min',
                                     compute='_compute_reaktion_time', store=True, help='Time in hours')
    reaction_time_max = fields.Float(string='Reaction Time (MAX)', aggregator='max',
                                     compute='_compute_reaktion_time', store=True, help='Time in hours')
    time_until_work_start_avg = fields.Float(aggregator='avg', string='Resolution Time (AVG)',
                                             compute='_compute_time_until_work_start', store=True, help='Time in hours')
    time_until_work_start_max = fields.Float(aggregator="max", string='Resolution Time (MAX)',
                                             compute='_compute_time_until_work_start', store=True, help='Time in hours')
    time_until_work_start_min = fields.Float(aggregator="min", string='Resolution Time (MIN)',
                                             compute='_compute_time_until_work_start', store=True, help='Time in hours')
    time_until_work_done_avg = fields.Float(aggregator='avg', string='Arrival Time (AVG)',
                                            compute='_compute_time_until_work_done', store=True, help='Time in hours')
    time_until_work_done_min = fields.Float(aggregator='min', string='Arrival Time (MIN)',
                                            compute='_compute_time_until_work_done', store=True, help='Time in hours')
    time_until_work_done_max = fields.Float(aggregator='max', string='Arrival Time (MAX)',
                                            compute='_compute_time_until_work_done', store=True, help='Time in hours')
    ##endif
